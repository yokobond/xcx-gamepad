...
var WebGamePadBlocks = /*#__PURE__*/function () {
  ...
  _createClass(WebGamePadBlocks, [{
    ...
    value: function addGamepad(gamepad) {
      ...
      log.info("added: controller[".concat(gamepad.index, "]"));
      log.debug(gamepad);
    }
  }, {
    key: "removeGamepad",
    value: function removeGamepad(gamepad) {
      log.info("removed: controller[".concat(gamepad.index, "]"));
...
var blockClass = WebGamePadBlocks; // loadable-extension needs this line.

var _webGamepad = WebGamePadBlocks;
_webGamepad.blockClass = blockClass;

export { _webGamepad as __moduleExports, blockClass, entry };
